...
const THEMES = [
  {
    ...
    bgPatterns:   ['rain-window-streams', 'rain-cloud-wash', 'rain-puddle-lines', 'rain-soft-drizzle', 'rain-street-reflections'],
  ...
  },
  {
    ...
    bgPatterns:   ['book-page-lines', 'book-library-shadows', 'book-margin-notes', 'book-spine-bands', 'book-paper-grain'],
  ...
  },
  {
    ...
    bgPatterns:   ['silk-fabric-folds', 'silk-perfume-mist', 'silk-ribbon-flow', 'silk-vanity-lines', 'silk-jasmine-drift'],
  ...
  },
  {
    ...
    bgPatterns:   ['henna-fine-dots', 'henna-paisley-flow', 'henna-palm-lines', 'henna-bangle-bands', 'henna-leaf-trails'],
  ...
  },
  {
    ...
    bgPatterns:   ['golden-sun-rays', 'golden-horizon-bands', 'golden-curtain-glow', 'golden-balcony-lines', 'golden-evening-haze'],
  ...
  },
  {
    ...
    bgPatterns:   ['hf-signature-weave', 'hf-initial-lines', 'hf-heartbeat-flow', 'hf-keepsake-ribbons', 'hf-forever-glow'],
...
const ARCHIVED_THEMES = [
  // Archived September 2026 (romantic collection refresh)
  {
    ...
    palette: {
      ...
      shape:  ['#b3125a', '#92510a', '#00796f'],
      accent: ['#c2185b', '#007d73', '#7b2cbf'],
    },
    ...
    boardBg:      { pattern: 'love-paper-lines', color: '#ff6b8a' },
  },
  {
    name: 'Moonlit Promise', emoji: '🌙',
    palette: {
      bg:     ['#3659d9', '#a855f7', '#ff704d'],
      ring:   ['#17348f', '#6421a6', '#a32a18', '#00616d'],
      shape:  ['#2142a8', '#712bb5', '#b83220'],
      accent: ['#8a1f85', '#00727c', '#bd321f'],
    },
    ...
    boardBg:      { pattern: 'moon-night-waves', color: '#3659d9' },
  },
  {
    name: 'Rose Garden', emoji: '🌹',
    palette: {
      bg:     ['#f43f6f', '#65b741', '#f5a623'],
      ring:   ['#9f123f', '#2f6d1f', '#8a5800', '#61218a'],
      shape:  ['#b5164b', '#347c21', '#966000'],
      accent: ['#c21855', '#14734d', '#7026a0'],
    },
    ...
    boardBg:      { pattern: 'rose-vine-lines', color: '#f43f6f' },
  },
  {
    name: 'Home With You', emoji: '🏡',
    style: 'bold-sticker',
    palette: {
      bg:     ['#f47b45', '#4dba91', '#4f83d1'],
      ring:   ['#96340d', '#087252', '#1e4f9e', '#7a245d'],
      shape:  ['#aa3b10', '#0b805c', '#245bac'],
      accent: ['#a41652', '#087a64', '#572aa0'],
    },
    ...
    boardBg:      { pattern: 'home-quilt-stitches', color: '#f47b45' },
  },
  {
    name: 'Shared Journeys', emoji: '🧭',
    style: 'bold-sticker',
    palette: {
      bg:     ['#079a9a', '#e66a32', '#8b5cf6'],
      ring:   ['#006466', '#97330d', '#5225a8', '#687000'],
      shape:  ['#007276', '#aa3d12', '#5f2db8'],
      accent: ['#a11455', '#007567', '#702ab3'],
    },
    ...
    boardBg:      { pattern: 'journey-route-lines', color: '#079a9a' },
  },
  {
    ...
    palette: {
      ...
      shape:  ['#94164f', '#9b7000', '#006c73'],
      accent: ['#a7195b', '#00776d', '#74249b'],
    },
    ...
    boardBg:      { pattern: 'fatema-signature-lines', color: '#c0266d' },
  },
