// Shared thin wrapper around OpenAI's images/edits endpoint using Node's
// built-in fetch/FormData/Blob — no SDK dependency. Extracted from
// tools/birthday-studio/openaiClient.js so the permanent production Rida
// Studio game and the local-only tool share one call path without the
// production server depending on the local tool's code.
//
