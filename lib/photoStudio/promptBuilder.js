...
const FRESH_RIDA_CLAUSE =
  ...
  "candidate must use a fresh rida color palette and design distinct from all reference outfits while " +
  "keeping Fatema's face, identity, body, and authentic rida attire consistent.";
