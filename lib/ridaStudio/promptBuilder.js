...
function buildPrompt(selections, {
  ...
  const baseClothPhrase = hasBaseClothReference
    ? [
      ...
      "Do not substitute a merely similar palette or generic pattern. Both generated candidates must visibly derive their base cloth from this same uploaded source, and clothing in the identity photos must contribute no colors or design details.",
    ].join(' ')
    : baseDescription
