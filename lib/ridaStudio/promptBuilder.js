    ...
    ? hasCompleteRidaReference
      ? [
        ...
        completeRidaDescription
          ? `Use this literal whole-garment specification to clarify the complete-rida source: "${completeRidaDescription}". The photo remains controlling wherever the two conflict.`
          : '',
      ].filter(Boolean).join(' ')
