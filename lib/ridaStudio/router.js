...
function createRouter() {
  ...
  router.post('/generate', requireAuth, requireJsonBody, async (req, res) => {
    ...
    try {
      ...
      // The first edit image establishes the person. Keep Fatema's primary
      // identity photo first, then garment-only uploads, then supporting
      // identity views. The prompt assigns strict roles to every index.
