...
const PANELS = {
  surprise: {
    label: 'Surprise Me',
    icon: '✨',
    desc: 'a fresh coordinated standard (6-8 inch) or broad (8-10 inch) panel treatment chosen for this generation',
  },
  none: {
    label: 'No Panel',
    icon: '○',
  ...
  coordinatedWide: {
    label: 'Broad Coordinated Panel (8-10 in)',
    icon: '▰',
    desc: 'a broad coordinated fabric panel with 8-10 inches of vertical height near the lower ghagra',
  },
  contrastPanel: {
  ...
  layeredPanel: {
    label: 'Broad Layered Festive Panel (8-10 in)',
    icon: '✨',
    desc: 'a broad layered festive panel with coordinated fabric bands totaling 8-10 inches of vertical height near the ghagra hem',
  },
  subtlePanel: {
