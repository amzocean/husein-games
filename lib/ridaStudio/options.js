...
const COLORS = {
  surprise: {
    label: 'Surprise Me',
    swatch: ['#f06ca5', '#78cfe5'],
    desc: 'a fresh, harmonious color palette chosen for this generation',
  },
  rosePearl: {
...
const MOTIFS = {
  surprise: {
    label: 'Surprise Me',
    icon: '✨',
    desc: 'a fresh, tasteful fabric motif chosen for this generation',
  },
  floralVines: {
    label: 'Floral Vines',
    icon: '🌿',
...
const BORDERS = {
  surprise: {
    label: 'Surprise Me',
    icon: '✨',
    desc: 'a fresh coordinated border or lace treatment chosen for this generation',
  },
  none: {
    label: 'No Lace',
    icon: '○',
...
const PANELS = {
  surprise: {
    label: 'Surprise Me',
    icon: '✨',
    desc: 'a fresh coordinated standard (6-8 inch) or extra-broad (10-16 inch) panel treatment chosen for this generation',
  },
  none: {
    label: 'No Panel',
    icon: '○',
  ...
  coordinatedWide: {
    label: 'Extra-Broad Coordinated Panel (10-16 in)',
    icon: '▰',
    desc: 'an extra-broad coordinated fabric panel with 10-16 inches of clearly visible vertical height near the lower ghagra',
  },
  contrastPanel: {
    label: 'Standard Contrast Panel (6-8 in)',
    icon: '◫',
    desc: 'a standard contrast-color panel with 6-8 inches of vertical height near the lower ghagra',
  },
  scallopedPanel: {
    label: 'Standard Scalloped Panel (6-8 in)',
    icon: '〰️',
    desc: 'a standard scalloped lower panel with 6-8 inches of vertical height following the ghagra circumference',
  },
  layeredPanel: {
    label: 'Extra-Broad Layered Festive Panel (10-16 in)',
    icon: '✨',
    desc: 'an extra-broad layered festive panel with coordinated fabric bands totaling 10-16 inches of vertical height near the ghagra hem',
  },
  subtlePanel: {
    label: 'Standard Subtle Panel (6-8 in)',
    icon: '➖',
    desc: 'an understated standard coordinated panel with 6-8 inches of vertical height near the bottom of the ghagra',
  },
};
